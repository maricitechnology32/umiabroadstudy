                  ...
                  <div className="relative rounded-lg overflow-hidden bg-white aspect-[16/10] md:aspect-[21/9] flex group">
                     ...
                     <div className="w-16 md:w-56 bg-primary-900 border-r border-primary-800 flex flex-col pt-5 pb-4">
                        <div className="px-4 mb-6 flex items-center gap-3">
                           <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center text-white font-bold text-sm shrink-0">UMI</div>
               ...
               <div className="col-span-2 md:col-span-1">
                  <div className="flex items-center gap-2 mb-6">
                     {branding?.logo ? (
                        ...
                        <img src="/logo.jpg" alt="UMI Abroad Study" className="w-8 h-8 rounded-lg object-cover" />
                     )}
