...
const Footer = () => {
    ...
    // Logic: If logged in or has token, show consultancy branding, otherwise default to Global Flow
    ...
    const displayLogo = showConsultancyBranding && branding?.logo ? fixImageUrl(branding.logo) : '/logo.png';
                            ...
                            <Link to="/" className="flex items-center gap-3 group">
                                <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center shadow-lg shadow-primary-900/20 overflow-hidden group-hover:scale-105 transition-transform duration-300">
                                    {showConsultancyBranding && branding?.logo ? (
                                        ...
                                        <img src="/logo.png" alt="UMI Abroad Study" className="w-full h-full object-cover" />
                                    )}
                                </div>
