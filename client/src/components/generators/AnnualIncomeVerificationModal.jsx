...
//         // Generate table rows with compact styling (12pt to match PDF)
//         const tableRows = formData.incomeData.map((row, index) => `
//         <tr style="height: 14pt; mso-height-rule: exactly;">
//             <td style="border: 1px solid black; padding: 0 2px; text-align: center; font-size: 12pt; font-family: 'Times New Roman', serif; line-height: 12pt; mso-line-height-rule: exactly;">${index + 1}</td>
//             <td style="border: 1px solid black; padding: 0 2px; text-align: left; font-size: 12pt; font-family: 'Times New Roman', serif; line-height: 12pt; mso-line-height-rule: exactly;">${row.source}</td>
//             <td style="border: 1px solid black; padding: 0 2px; text-align: right; font-size: 12pt; font-family: 'Times New Roman', serif; line-height: 12pt; mso-line-height-rule: exactly;">${formatCurrency(row.amount1)}</td>
//             <td style="border: 1px solid black; padding: 0 2px; text-align: right; font-size: 12pt; font-family: 'Times New Roman', serif; line-height: 12pt; mso-line-height-rule: exactly;">${formatCurrency(row.amount2)}</td>
//             <td style="border: 1px solid black; padding: 0 2px; text-align: right; font-size: 12pt; font-family: 'Times New Roman', serif; line-height: 12pt; mso-line-height-rule: exactly;">${formatCurrency(row.amount3)}</td>
//         </tr>
//     `).join('');
...
//     <head>
//         <meta charset="utf-8">
//         <title>Annual Income Verification Certificate</title>
...
//                 <w:pgMar w:top="850" w:bottom="850" w:left="1440" w:right="1440" w:header="0" w:footer="0"/>
//             </w:Section>
//         </xml>
//         <![endif]-->
//         <style>
...
//             @page {
//                 size: A4;
//                 margin: 1.5cm 2.54cm 1.5cm 2.54cm;
...
//             /* Header Styles - Match PDF exactly */
//             .header-container {
//                 width: 100%;
//                 margin-bottom: 0;
//             }
...
//             /* Table Styles - Compact (12pt to match PDF) */
//             .income-table {
//                 width: 100%;
...
//                 </td>
//                 <td style="width: 70%; text-align: center; vertical-align: top; padding: 0 5pt;">
//                     <div style="font-size: 24pt; font-weight: bold; color: #DC2626; line-height: 1; margin-bottom: 2px; text-align: center; font-family: 'Times New Roman', serif;">${formData.headerTitle}</div>
//                     <div style="font-size: 18pt; font-weight: bold; color: #DC2626; line-height: 1; margin-bottom: 2px; text-align: center; font-family: 'Times New Roman', serif;">${formData.headerSubtitle}</div>
//                     <div style="font-size: 16pt; font-weight: bold; color: #DC2626; line-height: 1; margin-bottom: 2px; text-align: center; font-family: 'Times New Roman', serif;">${formData.headerAddress1}</div>
//                     <div style="font-size: 16pt; font-weight: bold; color: #DC2626; line-height: 1; text-align: center; font-family: 'Times New Roman', serif;">${formData.headerAddress2}</div>
//                 </td>
...
//         <!-- Red Line (copied from footer structure) -->
//         <div style="margin-top: 0; margin-bottom: 0; border-top: 3px solid #DC2626; padding-top: 0; padding-bottom: 0; margin-left: -1in; margin-right: -1in; padding-left: 1in; padding-right: 1in;"></div>
//     </div>
//     ` : ''}

//     <!-- MAIN CONTENT -->
//     <div class="main-title">Annual Income Verification Certificate</div>
...
//             <!-- Total Row - NPR -->
//             <tr class="total-row">
//                 <td colspan="2" style="text-align: right; padding-right: 8pt;">Total Amount (NPR)</td>
//                 <td class="text-right">${formatCurrency(totals.totalNPR[0])}</td>
//                 <td class="text-right">${formatCurrency(totals.totalNPR[1])}</td>
//                 <td class="text-right">${formatCurrency(totals.totalNPR[2])}</td>
//             </tr>
//             <!-- Total Row - USD -->
//             <tr class="total-row">
//                 <td colspan="2" style="text-align: right; padding-right: 8pt;">Total Amount (US$)</td>
//                 <td class="text-right">${formatCurrency(totals.totalUSD[0])}</td>
//                 <td class="text-right">${formatCurrency(totals.totalUSD[1])}</td>
//                 <td class="text-right">${formatCurrency(totals.totalUSD[2])}</td>
//             </tr>
//         </tbody>
//     </table>
...
//         (Source: Nepal Rastra Bank -  for ${formatExchangeRateDateWithSuperscript(exchangeRateInfo.date)}).
//     </p>
...
//     <ol>
//         <li>Fiscal Year ${fiscalYearLabels[0]} (For the period of ${getFormattedFiscalDate(fiscalYearData[0].startDateObj)} to ${getFormattedFiscalDate(fiscalYearData[0].endDateObj)}).</li>
//         <li>Fiscal Year ${fiscalYearLabels[1]} (For the period of ${getFormattedFiscalDate(fiscalYearData[1].startDateObj)} to ${getFormattedFiscalDate(fiscalYearData[1].endDateObj)}).</li>
//         <li>Fiscal Year ${fiscalYearLabels[2]} (For the period of ${getFormattedFiscalDate(fiscalYearData[2].startDateObj)} to ${getFormattedFiscalDate(fiscalYearData[2].endDateObj)}).</li>
//     </ol>
...
//     <!-- FOOTER (flows naturally after signature) -->
//     <div style="margin-top: 0; margin-bottom: 0; border-top: 3px solid #DC2626; padding-top: 2pt; padding-bottom: 0; margin-left: -1in; margin-right: -1in; padding-left: 1in; padding-right: 1in;">
//         <table style="width: 100%; font-size: 9pt; color: #DC2626; font-weight: bold; font-family: 'Times New Roman', serif; line-height: 1;">
//             <tr style="height: 12pt;">
//                 <td style="text-align: left; padding: 0;">Phone No.: ${formData.footerPhone}</td>
//                 <td style="text-align: right; padding: 0;">E-mail: ${formData.footerEmail}</td>
//             </tr>
//         </table>
//     </div>
//     ` : ''}
...
<div>
    <table width="100%" cellspacing="0" cellpadding="0" style="border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
        <tr>
            ...
            <td width="70%" style="text-align: center; vertical-align: top;">
                <p style="margin: 0; line-height: 1.0; margin-bottom: 2pt;"><span style="font-size: 24.0pt; font-family: 'Times New Roman',serif; color: #DC2626; font-weight: bold;">${formData.headerTitle}</span></p>
                <p style="margin: 0; line-height: 1.0; margin-bottom: 2pt;"><span style="font-size: 18.0pt; font-family: 'Times New Roman',serif; color: #DC2626; font-weight: bold;">${formData.headerSubtitle}</span></p>
                <p style="margin: 0; line-height: 1.0; margin-bottom: 2pt;"><span style="font-size: 16.0pt; font-family: 'Times New Roman',serif; color: #DC2626; font-weight: bold;">${formData.headerAddress1}</span></p>
                <p style="margin: 0; line-height: 1.0;"><span style="font-size: 16.0pt; font-family: 'Times New Roman',serif; color: #DC2626; font-weight: bold;">${formData.headerAddress2}</span></p>
            </td>
            <td width="15%"></td>
        </tr>
    </table>
    ...
    <!-- Reference and Date -->
    <table width="100%" cellspacing="0" cellpadding="0" style="margin-top: 4pt; margin-bottom: 2pt; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
        <tr>
            <td width="50%" align="left" valign="bottom" style="vertical-align: bottom;">
                <p style="margin: 0; line-height: 1.2;">
                    <span style="font-size: 16.0pt; font-family: 'Times New Roman',serif; color: #DC2626; font-weight: bold;">Ref. No.:</span> 
                    <span style="font-size: 16.0pt; font-family: 'Times New Roman',serif; font-weight: bold;">${formData.refNo}</span><br>
                    <span style="font-size: 16.0pt; font-family: 'Times New Roman',serif; color: #DC2626; font-weight: bold;">Dis. No.:</span> 
                    <span style="font-size: 16.0pt; font-family: 'Times New Roman',serif; font-weight: bold;">${formData.disNo}</span>
                </p>
            </td>
            <td width="50%" align="right" valign="bottom" style="vertical-align: bottom;">
                <p style="margin: 0; line-height: 1.2; text-align: right;">
                    <span style="font-size: 16.0pt; font-family: 'Times New Roman',serif; color: #DC2626; font-weight: bold;">Date:</span> 
                    <span style="font-size: 16.0pt; font-family: 'Times New Roman',serif; font-weight: bold;">${formatCurrentDate()}</span>
                </p>
            </td>
        </tr>
    </table>
